...
<head>
    ...
    <title>Card Actions - Robust Free Bootstrap Admin Template</title>
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="index.php" class="navbar-brand nav-link"><img alt="branding logo" src="{{asset('app-assets/images/logo/robust-logo-light.png')}}" data-expand="app-assets/images/logo/robust-logo-light.png" data-collapse=app-assets/images/logo/robust-logo-small.png" class="brand-logo"></a></li>
        ...
        <div class="navbar-container content container-fluid">
            <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                ...
                <ul class="nav navbar-nav float-xs-right">
                    ...
                    <li class="dropdown dropdown-user nav-item"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link"><span class="avatar avatar-online"><img src="{{asset('app-assets/images/portrait/small/avatar-s-1.png')}}" alt="avatar"><i></i></span><span class="user-name"> <?php if(isset($_SESSION['Username'])){echo $_SESSION["Username"];}else{echo '';}?> </span></a>
...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
    ...
    <div class="main-menu-content">
        <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
            <li class=" nav-item"><a href="index.php"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">لوحة التحكم</span></a>
                <ul class="menu-content">
                    <li><a href="users.php" data-i18n="nav.dash.main" class="menu-item">المدراء</a></li>
                    <li><a href="index.php" data-i18n="nav.dash.main" class="menu-item">رسائل الزوار</a></li>
                </ul>

                <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                    <li class=" nav-item"><a href="index.php"><i class="icon-folder-open"></i><span data-i18n="nav.dash.main" class="menu-title">الأعمال</span></a>
                        <ul class="menu-content">
                            <li><a href="projects.php" data-i18n="nav.dash.main" class="menu-item">الاعمال السابقة</a></li>
                            <li><a href="add_projects.php" data-i18n="nav.dash.main" class="menu-item">اضافة عمل  جديد</a></li>
                        </ul>
                </ul>
...
<footer class="footer footer-static footer-light navbar-border" >
    <p class="clearfix text-muted text-sm-center mb-0 px-2">
        <span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2020 <a href="https://themeforest.net/user/pixinvent/portfolio?ref=pixinvent" target="_blank" class="text-bold-800 grey darken-2">Created By YousfSamiy </a>, All rights reserved. </span><span class="float-md-right d-xs-block d-md-inline-block">Larvel Web Project <i  class="icon-heart5 pink"></i></span>
    </p>
</footer>
